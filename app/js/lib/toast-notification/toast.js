...
function initToast() {
    ...
    addCSSRule(sheet,
        ...
        'height: 30px;' +
        'border-radius: 50%;' +
        'background: #FE715B url("js/lib/toast-notification/img/8HPeCj6.png") no-repeat center;' +
    ...
    addCSSRule(sheet,
        '.success .error_inner',
        'background-image: url("js/lib/toast-notification/img/HxkisKF.png");'
    );
    ...
    addCSSRule(sheet,
        '.loader .error_inner',
        'background-image: url("js/lib/toast-notification/img/pE6u31C.gif");'
    );
